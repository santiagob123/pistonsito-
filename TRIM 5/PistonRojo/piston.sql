...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2024 a las 19:07:29
...
--
DELIMITER $$
CREATE TRIGGER `registrar_cambio_estado_cita` AFTER UPDATE ON `cita` FOR EACH ROW BEGIN
    IF OLD.Id_estadoCita != NEW.Id_estadoCita THEN
        INSERT INTO historial_cambios_cita (Id_Citas, Estado_Antiguo, Estado_Nuevo, Fecha_Cambio)
        VALUES (NEW.Id_Citas, OLD.Id_estadoCita, NEW.Id_estadoCita, NOW());
    END IF;
END
$$
DELIMITER ;
...
--
-- Estructura de tabla para la tabla `historial_cambios_cita`
--

CREATE TABLE `historial_cambios_cita` (
  `Id_Historial` int(11) NOT NULL,
  `Id_Citas` int(11) NOT NULL,
  `Estado_Antiguo` int(11) NOT NULL,
  `Estado_Nuevo` int(11) NOT NULL,
  `Fecha_Cambio` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `historial_cambios_cita`
--

INSERT INTO `historial_cambios_cita` (`Id_Historial`, `Id_Citas`, `Estado_Antiguo`, `Estado_Nuevo`, `Fecha_Cambio`) VALUES
(1, 1, 3, 2, '2024-09-30 06:12:11'),
(2, 1, 2, 1, '2024-10-20 18:25:21'),
(3, 1, 1, 2, '2024-10-20 19:13:49'),
(4, 1, 2, 1, '2024-10-20 19:14:21'),
(5, 1, 1, 3, '2024-10-20 19:15:07'),
(6, 1, 3, 1, '2024-10-20 19:18:15'),
(7, 1, 1, 2, '2024-10-20 19:19:59'),
(8, 1, 2, 1, '2024-10-20 19:43:01'),
(9, 1, 1, 2, '2024-10-20 19:43:05'),
(10, 1, 2, 1, '2024-10-20 19:44:05');
...
(1, 'REF1238', 'Filtro de aceite', 18, 15000, 'Suzuki Genuine Parts', 10, 1, 4),
...
(6, 'REF0123', 'Bujías', 12, 10000, 'Kymco Genuine Parts', 3, 7, 1),
...
(1, 123456789, 'Repuestos Moto ABC', '+57 312 3456789', 'Calle 10 # 12-34, Bogotá, Colombia', 'repuestosmotoabc@ejemplo.com', '1'),
(2, 987654321, 'Motos El Rápido', '+57 310 9876543', 'Carrera 15 # 23-45, Medellín, Colombia', 'motoseldrapido@ejemplo.com', '1'),
(3, 1000000001, 'Repuestos Originales', '+57 311 1234567', 'Avenida Jiménez # 56-78, Cali, Colombia', 'repuestosoriginales@ejemplo.com', '1'),
(4, 234567890, 'Moto Partes Express', '+57 313 2345678', 'Diagonal 70 # 90-12, Barranquilla, Colombia', 'motopartexpress@ejemplo.com', '1'),
(5, 345678901, 'Repuestos Moto Fácil', '+57 314 3456789', 'Calle 50 # 13-15, Bucaramanga, Colombia', 'repuestosmotofacil@ejemplo.com', '1'),
(6, 2000000002, 'Suministros Moto', '+57 315 4567890', 'Carrera 40 # 16-18, Cartagena, Colombia', 'suministrosmoto@ejemplo.com', '1'),
(7, 456789012, 'Moto Repuestos Económicos', '+57 316 5678901', 'Avenida Pedro de Heredia # 19-21, Santa Marta', 'motorepuestoseconmicos@ejemplo.com', '1'),
(8, 567890123, 'Repuestos Moto Elite', '+57 317 6789012', 'Calle Real # 22-24, Montería, Colombia', 'repuestosmotoelite@ejemplo.com', '1'),
(9, 2147483647, 'Moto Partes del Sur', '+57 318 7890123', 'Carrera 7 # 25-27, Neiva, Colombia', 'motopartedessur@ejemplo.com', '1'),
(10, 678901234, 'Repuestos Moto Importados', '+57 319 8901234', 'Avenida Ambalá # 28-30, Villavicencio, Colomb', 'repuestosmotoimportados@ejemplo.com', '1'),
(11, 1029143013, 'Hermanos Ortega', '3053055073', 'Cra 5', 'Hermanos@ejemplo.com', '1');
...
--
-- Indices de la tabla `historial_cambios_cita`
--
ALTER TABLE `historial_cambios_cita`
...
--
-- AUTO_INCREMENT de la tabla `historial_cambios_cita`
--
ALTER TABLE `historial_cambios_cita`
...
--
-- Filtros para la tabla `historial_cambios_cita`
--
ALTER TABLE `historial_cambios_cita`
  ADD CONSTRAINT `historial_cambios_cita_ibfk_1` FOREIGN KEY (`Id_Citas`) REFERENCES `cita` (`Id_Citas`);
